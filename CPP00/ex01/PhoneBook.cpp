...
void	PhoneBook::search()
{
	...
	std::string	index;
	std::cout << std::endl << "\033[0;34m>> \033[0;36mEnter index of contact to see more details: \033[0m";
	std::cout << std::endl << "\033[0;34m--> \033[0m";
	std::cin >> index;
	if (index.length() == 1 && std::isdigit(index[0])
		&& std::stoi(index) <= table_size && std::stoi(index) != 0)
	{
		std::cout << std::endl << "\033[0;35mShowing inf of contact #" << index << std::endl;
		std::cout << std::endl << "\033[0mFull Name:\t\t" << contacts[std::stoi(index) - 1].get_first_name() << std::endl;
		std::cout << std::endl << "First Name:\t\t" << contacts[std::stoi(index) - 1].get_last_name() << std::endl;
		std::cout << std::endl << "Nick:\t\t\t" << contacts[std::stoi(index) - 1].get_nick() << std::endl;
		std::cout << std::endl << "Phone Number:\t\t" << contacts[std::stoi(index) - 1].get_phone_number() << std::endl;
		std::cout << std::endl << "Darkest Secret:\t\t" << contacts[std::stoi(index) - 1].get_secret() << std::endl;
	}
	else
